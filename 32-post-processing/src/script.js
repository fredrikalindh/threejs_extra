...
gui.add(unrealBloomPass, "strength", 0.0, 1.0);
gui.add(unrealBloomPass, "radius", 0.0, 1.0);
gui.add(unrealBloomPass, "threshold", 0.0, 1.0);
...
gui.add(tintPass.material.uniforms.uTint.value, "x", 0, 1);
gui.add(tintPass.material.uniforms.uTint.value, "y", 0, 1);
gui.add(tintPass.material.uniforms.uTint.value, "z", 0, 1);
...
const DisplacementShader = {
    ...
    fragmentShader: `
        ...
        void main() {
            ...
            color.rgb += pow(lightness * 4.0, 2.0);
